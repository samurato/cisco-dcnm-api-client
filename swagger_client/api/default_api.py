...
class DefaultApi(object):
    ...
    def rest_logon_post(self, **kwargs):  # noqa: E501
        """dcnm login - gather token  # noqa: E501

        Used to gather the DCNM token for API operations.  Authenticates using encoding of the username and password defined within the ENV.  The returned key is added to an ENV var for use by every other DCNM API call using a JS test.  Timeout value is excessively long for testing purposes and is defined in milliseconds  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_logon_post(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.rest_logon_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.rest_logon_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def rest_logon_post_with_http_info(self, **kwargs):  # noqa: E501
        """dcnm login - gather token  # noqa: E501

        Used to gather the DCNM token for API operations.  Authenticates using encoding of the username and password defined within the ENV.  The returned key is added to an ENV var for use by every other DCNM API call using a JS test.  Timeout value is excessively long for testing purposes and is defined in milliseconds  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_logon_post_with_http_info(async_req=True)
        >>> result = thread.get()
