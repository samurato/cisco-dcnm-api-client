...
class InterfaceOperationsApi(object):
    ...
    def rest_interface_adminstatus_post(self, **kwargs):  # noqa: E501
        """shutdown interface  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_adminstatus_post(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.rest_interface_adminstatus_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.rest_interface_adminstatus_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def rest_interface_adminstatus_post_with_http_info(self, **kwargs):  # noqa: E501
        """shutdown interface  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_adminstatus_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method rest_interface_adminstatus_post" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/rest/interface/adminstatus', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def rest_interface_deploy_post(self, **kwargs):  # noqa: E501
        """deploy interface  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_deploy_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rest_interface_deploy_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.rest_interface_deploy_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def rest_interface_deploy_post_with_http_info(self, **kwargs):  # noqa: E501
        """deploy interface  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_deploy_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rest_interface_deploy_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def rest_interface_get(self, **kwargs):  # noqa: E501
        """query inteface  # noqa: E501

        Returns the Policy attached with each interface and corresponding config parameters(`nv_pairs`)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rest_interface_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.rest_interface_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def rest_interface_get_with_http_info(self, **kwargs):  # noqa: E501
        """query inteface  # noqa: E501

        Returns the Policy attached with each interface and corresponding config parameters(`nv_pairs`)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['dcnm_token', 'serial_number', 'if_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rest_interface_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'if_name' in params:
            query_params.append(('ifName', params['if_name']))  # noqa: E501
    ...
    def rest_interface_post(self, **kwargs):  # noqa: E501
        """config ethernet  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_post(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rest_interface_post_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.rest_interface_post_with_http_info(**kwargs)  # noqa: E501
            return data

    def rest_interface_post_with_http_info(self, **kwargs):  # noqa: E501
        """config ethernet  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_post_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rest_interface_post" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def rest_interface_post_0(self, **kwargs):  # noqa: E501
        """create routed subif  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_post_0(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.rest_interface_post_0_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.rest_interface_post_0_with_http_info(**kwargs)  # noqa: E501
            return data

    def rest_interface_post_0_with_http_info(self, **kwargs):  # noqa: E501
        """create routed subif  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.rest_interface_post_0_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method rest_interface_post_0" % key
                )
            params[key] = val
        del params['kwargs']
